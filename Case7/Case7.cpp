/*Name of the program:To perform the add delete modiefy of configuration into a file.
filename:Case7.cpp
date:11-04-2020
...
int main(int argc, char *argv[])
{
	if(argc>=2)
	    ...
	    {
            cout<<"This program is to add delete and edit the configuration in a file "<<endl;
	    }
    }
	else
	{
